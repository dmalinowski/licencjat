...
\begin{proof}
  ...
  Stąd chcąc przekształcić $\langle v_i \rangle$ na $\langle w_i \rangle$ dla $i = 1, 2$ dopełniamy $v_i$ do bazy $v_1, \ldots, v_n$
  ...
  $$
  Natomiast, gdy $n \ge 3$ oraz $j \ne k$ to z przechodniości naturalnego działania grupy $A_n$ na zbiorze $\{1, 2, \ldots, n \}$ 
